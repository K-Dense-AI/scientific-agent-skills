...
compatibility: Requires Python 3.9+ (bioservices 1.16.0 declares >=3.9,<4.0 and classifies 3.9 through 3.14; checked 2026-09-09) and internet access to 40+ bioinformatics web APIs. NCBI BLAST requires a contact email (`NCBI_EMAIL` env var or explicit parameter).
metadata:
  version: "1.5"
